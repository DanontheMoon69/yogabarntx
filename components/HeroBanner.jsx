    ...
    <>
      <div className="bg-gray-100 mr-3 mt-2">
        <div className=" flex sm:w-full overflow-hidden  rounded-xl my-2">
          <div className="lg:ml-10 flex-col lg:w-1/2 lg:rounded-xl  justify-center text-start items-center  py-4 px-4 sm:px-4 lg:py-16 lg:px-4 mr-4 ">
            <span>View March</span>
            ...
            <p className="ml-1 mr-5 sm:pr-0 sm:ml-8 sm:w-full md:w-3/4 text-sm mt-4 text-gray-400 ">
              ...
              posture and improve your breathing, which can be beneficial for
              both physical and mental health. Yoga can help you become more
              mindful and in tune with your body, which can ultimately lead to
              greater self-awareness and self-care. Yoga is a great way to
              improve your physical, mental and emotional wellbeing. We
